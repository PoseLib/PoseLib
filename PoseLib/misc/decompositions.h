...
focals_from_fundamental_iterative(const Eigen::Matrix3_t &F, const Camera &camera1_prior, const Camera &camera2_prior,
                                  const int &max_iters = 50,
                                  const Eigen::Vector4_t &weights = Eigen::Vector4_t(5.0e-4, 1.0, 5.0e-4, 1.0));
