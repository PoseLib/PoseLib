...
std::pair<Camera, Camera> focals_from_fundamental_direct(const Eigen::Matrix3d &F, const Point2D &pp1,
                                                         const Point2D &pp2, double tol) {
    ...
    double f1 = std::sqrt(num / den);

    f11 = G(0, 0), f12 = G(1, 0), f13 = G(2, 0);
    f21 = G(0, 1), f22 = G(1, 1), f23 = G(2, 1);
    f31 = G(0, 2), f32 = G(1, 2), f33 = G(2, 2);    
    ...
    double f2 = std::sqrt(num / den);

    Camera camera1 = Camera("SIMPLE_PINHOLE", std::vector<double>{f1, pp1(0), pp1(1)}, -1, -1);
    Camera camera2 = Camera("SIMPLE_PINHOLE", std::vector<double>{f2, pp2(0), pp2(1)}, -1, -1);
...
Eigen::MatrixXd solver_robust_autocal(const Eigen::VectorXd& data, int *num_sols)
{
    ...
    Eigen::Matrix<double, 20, 20> C0; C0.setZero();
    Eigen::Matrix<double, 20, 16> C1; C1.setZero();
...
std::pair<Camera, Camera> focals_from_fundamental_iterative(const Eigen::Matrix3d &F, const Camera &camera1_prior,
    ...
    double cf1p1k_sq, cf1p2k_sq, cu1p1k_sq, cu1p2k_sq, cv1p1k_sq, cv1p2k_sq, cf2p1k_sq, cf2p2k_sq, cu2p1k_sq, cu2p2k_sq, cv2p1k_sq, cv2p2k_sq;
    ...
    for (k = 0; k < max_iters + 1; k++) {
        ...
        cf1p1k = 1 / w1 * (s2 * (2 * V11 * V12 * f1n + 2 * V21 * V22 * f1n) * (U12 * (U32 * u2n + U12 * (f2n_sq + u2n_sq) + U22 * u2n * v2n) + U22 * (U32 * v2n + U22 * (f2n_sq + v2n_sq) + U12 * u2n * v2n) + U32 * (U32 + U12 * u2n + U22 * v2n)) + s1 * (2 * f1n * V11 * V11 + 2 * f1n * V21 * V21) * (U11 * (U32 * u2n + U12 * (f2n_sq + u2n_sq) + U22 * u2n * v2n) + U21 * (U32 * v2n + U22 * (f2n_sq + v2n_sq) + U12 * u2n * v2n) + U31 * (U32 + U12 * u2n + U22 * v2n)));
        cf1p2k = 1 / w1 * (s1 * (2 * V11 * V12 * f1n + 2 * V21 * V22 * f1n) * (U11 * (U31 * u2n + U11 * (f2n_sq + u2n_sq) + U21 * u2n * v2n) + U21 * (U31 * v2n + U21 * (f2n_sq + v2n_sq) + U11 * u2n * v2n) + U31 * (U31 + U11 * u2n + U21 * v2n)) + s2 * (2 * f1n * V12 * V12 + 2 * f1n * V22 * V22) * (U11 * (U32 * u2n + U12 * (f2n_sq + u2n_sq) + U22 * u2n * v2n) + U21 * (U32 * v2n + U22 * (f2n_sq + v2n_sq) + U12 * u2n * v2n) + U31 * (U32 + U12 * u2n + U22 * v2n)));

        cu1p1k = 1 / w2 * (s1 * (U11 * (U32 * u2n + U12 * (f2n_sq + u2n_sq) + U22 * u2n * v2n) + U21 * (U32 * v2n + U22 * (f2n_sq + v2n_sq) + U12 * u2n * v2n) + U31 * (U32 + U12 * u2n + U22 * v2n)) * (V11 * V31 + V11 * (V31 + 2 * V11 * u1n + V21 * v1n) + V11 * V21 * v1n) + s2 * (U12 * (U32 * u2n + U12 * (f2n_sq + u2n_sq) + U22 * u2n * v2n) + U22 * (U32 * v2n + U22 * (f2n_sq + v2n_sq) + U12 * u2n * v2n) + U32 * (U32 + U12 * u2n + U22 * v2n)) * (V12 * V31 + V11 * (V32 + 2 * V12 * u1n + V22 * v1n) + V12 * V21 * v1n));
        cu1p2k = 1 / w2 * (s1 * (U11 * (U31 * u2n + U11 * (f2n_sq + u2n_sq) + U21 * u2n * v2n) + U21 * (U31 * v2n + U21 * (f2n_sq + v2n_sq) + U11 * u2n * v2n) + U31 * (U31 + U11 * u2n + U21 * v2n)) * (V12 * V31 + V11 * (V32 + 2 * V12 * u1n + V22 * v1n) + V12 * V21 * v1n) + s2 * (U11 * (U32 * u2n + U12 * (f2n_sq + u2n_sq) + U22 * u2n * v2n) + U21 * (U32 * v2n + U22 * (f2n_sq + v2n_sq) + U12 * u2n * v2n) + U31 * (U32 + U12 * u2n + U22 * v2n)) * (V12 * V32 + V12 * (V32 + 2 * V12 * u1n + V22 * v1n) + V12 * V22 * v1n));

        cv1p1k = 1 / w2 * (s1 * (U11 * (U32 * u2n + U12 * (f2n_sq + u2n_sq) + U22 * u2n * v2n) + U21 * (U32 * v2n + U22 * (f2n_sq + v2n_sq) + U12 * u2n * v2n) + U31 * (U32 + U12 * u2n + U22 * v2n)) * (V21 * V31 + V21 * (V31 + V11 * u1n + 2 * V21 * v1n) + V11 * V21 * u1n) + s2 * (U12 * (U32 * u2n + U12 * (f2n_sq + u2n_sq) + U22 * u2n * v2n) + U22 * (U32 * v2n + U22 * (f2n_sq + v2n_sq) + U12 * u2n * v2n) + U32 * (U32 + U12 * u2n + U22 * v2n)) * (V22 * V31 + V21 * (V32 + V12 * u1n + 2 * V22 * v1n) + V11 * V22 * u1n));
        cv1p2k = 1 / w2 * (s1 * (U11 * (U31 * u2n + U11 * (f2n_sq + u2n_sq) + U21 * u2n * v2n) + U21 * (U31 * v2n + U21 * (f2n_sq + v2n_sq) + U11 * u2n * v2n) + U31 * (U31 + U11 * u2n + U21 * v2n)) * (V22 * V31 + V21 * (V32 + V12 * u1n + 2 * V22 * v1n) + V11 * V22 * u1n) + s2 * (U11 * (U32 * u2n + U12 * (f2n_sq + u2n_sq) + U22 * u2n * v2n) + U21 * (U32 * v2n + U22 * (f2n_sq + v2n_sq) + U12 * u2n * v2n) + U31 * (U32 + U12 * u2n + U22 * v2n)) * (V22 * V32 + V22 * (V32 + V12 * u1n + 2 * V22 * v1n) + V12 * V22 * u1n));


        cf2p1k = 1 / w3 * (s1 * (2 * U11 * U12 * f2n + 2 * U21 * U22 * f2n) * (V11 * (V31 * u1n + V11 * (f1n_sq + u1n_sq) + V21 * u1n * v1n) + V21 * (V31 * v1n + V21 * (f1n_sq + v1n_sq) + V11 * u1n * v1n) + V31 * (V31 + V11 * u1n + V21 * v1n)) + s2 * (2 * f2n * U12 * U12 + 2 * f2n * U22 * U22) * (V11 * (V32 * u1n + V12 * (f1n_sq + u1n_sq) + V22 * u1n * v1n) + V21 * (V32 * v1n + V22 * (f1n_sq + v1n_sq) + V12 * u1n * v1n) + V31 * (V32 + V12 * u1n + V22 * v1n)));
        cf2p2k = 1 / w3 * (s2 * (2 * U11 * U12 * f2n + 2 * U21 * U22 * f2n) * (V12 * (V32 * u1n + V12 * (f1n_sq + u1n_sq) + V22 * u1n * v1n) + V22 * (V32 * v1n + V22 * (f1n_sq + v1n_sq) + V12 * u1n * v1n) + V32 * (V32 + V12 * u1n + V22 * v1n)) + s1 * (2 * f2n * U11 * U11 + 2 * f2n * U21 * U21) * (V11 * (V32 * u1n + V12 * (f1n_sq + u1n_sq) + V22 * u1n * v1n) + V21 * (V32 * v1n + V22 * (f1n_sq + v1n_sq) + V12 * u1n * v1n) + V31 * (V32 + V12 * u1n + V22 * v1n)));

        cu2p1k = 1 / w4 * (s1 * (V11 * (V31 * u1n + V11 * (f1n_sq + u1n_sq) + V21 * u1n * v1n) + V21 * (V31 * v1n + V21 * (f1n_sq + v1n_sq) + V11 * u1n * v1n) + V31 * (V31 + V11 * u1n + V21 * v1n)) * (U12 * U31 + U11 * (U32 + 2 * U12 * u2n + U22 * v2n) + U12 * U21 * v2n) + s2 * (V11 * (V32 * u1n + V12 * (f1n_sq + u1n_sq) + V22 * u1n * v1n) + V21 * (V32 * v1n + V22 * (f1n_sq + v1n_sq) + V12 * u1n * v1n) + V31 * (V32 + V12 * u1n + V22 * v1n)) * (U12 * U32 + U12 * (U32 + 2 * U12 * u2n + U22 * v2n) + U12 * U22 * v2n));
        cu2p2k = 1 / w4 * (s1 * (V11 * (V32 * u1n + V12 * (f1n_sq + u1n_sq) + V22 * u1n * v1n) + V21 * (V32 * v1n + V22 * (f1n_sq + v1n_sq) + V12 * u1n * v1n) + V31 * (V32 + V12 * u1n + V22 * v1n)) * (U11 * U31 + U11 * (U31 + 2 * U11 * u2n + U21 * v2n) + U11 * U21 * v2n) + s2 * (V12 * (V32 * u1n + V12 * (f1n_sq + u1n_sq) + V22 * u1n * v1n) + V22 * (V32 * v1n + V22 * (f1n_sq + v1n_sq) + V12 * u1n * v1n) + V32 * (V32 + V12 * u1n + V22 * v1n)) * (U12 * U31 + U11 * (U32 + 2 * U12 * u2n + U22 * v2n) + U12 * U21 * v2n));

        cv2p1k = 1 / w4 * (s1 * (V11 * (V31 * u1n + V11 * (f1n_sq + u1n_sq) + V21 * u1n * v1n) + V21 * (V31 * v1n + V21 * (f1n_sq + v1n_sq) + V11 * u1n * v1n) + V31 * (V31 + V11 * u1n + V21 * v1n)) * (U22 * U31 + U21 * (U32 + U12 * u2n + 2 * U22 * v2n) + U11 * U22 * u2n) + s2 * (V11 * (V32 * u1n + V12 * (f1n_sq + u1n_sq) + V22 * u1n * v1n) + V21 * (V32 * v1n + V22 * (f1n_sq + v1n_sq) + V12 * u1n * v1n) + V31 * (V32 + V12 * u1n + V22 * v1n)) * (U22 * U32 + U22 * (U32 + U12 * u2n + 2 * U22 * v2n) + U12 * U22 * u2n));
        cv2p2k = 1 / w4 * (s1 * (V11 * (V32 * u1n + V12 * (f1n_sq + u1n_sq) + V22 * u1n * v1n) + V21 * (V32 * v1n + V22 * (f1n_sq + v1n_sq) + V12 * u1n * v1n) + V31 * (V32 + V12 * u1n + V22 * v1n)) * (U21 * U31 + U21 * (U31 + U11 * u2n + 2 * U21 * v2n) + U11 * U21 * u2n) + s2 * (V12 * (V32 * u1n + V12 * (f1n_sq + u1n_sq) + V22 * u1n * v1n) + V22 * (V32 * v1n + V22 * (f1n_sq + v1n_sq) + V12 * u1n * v1n) + V32 * (V32 + V12 * u1n + V22 * v1n)) * (U22 * U31 + U21 * (U32 + U12 * u2n + 2 * U22 * v2n) + U11 * U22 * u2n));
        ...
        c214 =s2*(V32_sq + V12_sq*f1prior_sq + V22_sq*f1prior_sq)*(U32*(U11*cu2p2k + U21*cv2p2k) + U12*(U31*cu2p2k + 2*U11*cf2p2k* f2_prior) + U22*(U31*cv2p2k + 2*U21*cf2p2k* f2_prior)) + s1*(U31_sq + U11_sq*f2prior_sq + U21_sq*f2prior_sq)*(V32*(V11*cu1p2k + V21*cv1p2k) + V12*(V31*cu1p2k + 2*V11*cf1p2k* f1_prior) + V22*(V31*cv1p2k + 2*V21*cf1p2k* f1_prior)) + s1*(V31*V32 + V11*V12*f1prior_sq + V21*V22*f1prior_sq)*(U31*(U11*cu2p2k + U21*cv2p2k) + U11*(U31*cu2p2k + 2*U11*cf2p2k* f2_prior) + U21*(U31*cv2p2k + 2*U21*cf2p2k* f2_prior)) + s2*(U31*U32 + U11*U12*f2prior_sq + U21*U22*f2prior_sq)*(V32*(V12*cu1p2k + V22*cv1p2k) + V12*(V32*cu1p2k + 2*V12*cf1p2k* f1_prior) + V22*(V32*cv1p2k + 2*V22*cf1p2k* f1_prior));
        c215 =s2*(U31*U32 + U11*U12*f2prior_sq + U21*U22*f2prior_sq)*(V32_sq + V12_sq*f1prior_sq + V22_sq*f1prior_sq) + s1*(V31*V32 + V11*V12*f1prior_sq + V21*V22*f1prior_sq)*(U31_sq + U11_sq*f2prior_sq + U21_sq*f2prior_sq);
