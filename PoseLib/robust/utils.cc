...
double compute_sampson_msac_score(const Eigen::Matrix3d &E, const std::vector<Eigen::Vector2d> &x1, const std::vector<Eigen::Vector2d> &x2, double sq_threshold, size_t *inlier_count) {
    *inlier_count = 0;
