...
BundleStats bundle_adjust(const std::vector<Eigen::Vector2d> &x,
...
BundleStats bundle_adjust(const std::vector<Eigen::Vector2d> &points2D,
...
// Minimizes reprojection error. Assumes identity intrinsics (calibrated camera)
BundleStats generalized_bundle_adjust(const std::vector<std::vector<Eigen::Vector2d>> &x,
