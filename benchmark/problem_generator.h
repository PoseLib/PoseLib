...
struct CalibPoseValidator {
    ...
    static double compute_pose_error(const RelativePoseProblemInstance &instance, const CalibratedCameraPose &calib_pose);
    ...
    static bool is_valid(const RelativePoseProblemInstance &instance, const CalibratedCameraPose &pose, double tol);
};
