...
int main() {
    ...
    results.push_back(
        poselib::benchmark_homography<poselib::SolverHomography4pt_canonical<false>>(1e5, homo4pt_opt, tol));
    results.push_back(
        poselib::benchmark_homography<poselib::SolverHomography4pt_canonical<true>>(1e5, homo4pt_opt, tol));
