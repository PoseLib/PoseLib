...
const std::string example_camera5 = "4 OPENCV 3200 2400 2575.94 2608.29 1599.26 1257.13 0.141865 -0.465301 0 0"; // 1.23e-05 -5.55e-06
const std::string example_camera6 = "5 OPENCV 1024 768 868.993378 866.063001 525.942323 420.042529 -0.399431 0.188924 0.000153 0.000571";

//const std::string example_camera6 = "5 OPENCV_FISHEYE 4288 2848 1921.45 1922.76 2156.14 1446.19 -0.0447036 -0.00511989 -0.00034067 -6.7737e-05";
...
const std::vector<std::string> example_cameras = {example_camera1, example_camera2, example_camera3, example_camera4, example_camera5, example_camera6};
...
bool test_jacobian() {
    ...
    for(const std::string camera_txt : example_cameras) {
        ...
        for(size_t iter = 0; iter < 10; ++iter) {
            ...
            // Unproject
            double u,v;
            colmap::CameraModelImageToWorld(camera.model_id, camera.params, xp(0), xp(1), &u, &v);
            x(0) = u;
            x(1) = v;
            //camera.unproject(xp, &x);
