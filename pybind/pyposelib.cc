...
std::pair<CameraPose, py::dict> estimate_relative_pose_w_relative_depth_wrapper(const std::vector<Eigen::Vector2d> points2D_1,
                                                               const std::vector<Eigen::Vector2d> points2D_2,
    ...
    RansacStats stats =
        estimate_relative_pose_w_relative_depth(points2D_1, points2D_2, sigmas, camera1, camera2, ransac_opt, bundle_opt, &pose, &inlier_mask);
...
PYBIND11_MODULE(poselib, m) {
    ...
    m.def("estimate_relative_pose_w_relative_depth", &poselib::estimate_relative_pose_w_relative_depth_wrapper, py::arg("points2D_1"),
          py::arg("points2D_2"), py::arg("sigmas"), py::arg("camera1_dict"), py::arg("camera2_dict"), py::arg("ransac_opt") = py::dict(),
          py::arg("bundle_opt") = py::dict(), "Relative pose estimation with non-linear refinement.");
