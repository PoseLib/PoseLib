...
std::vector<CameraPose> p3p_wrapper(const std::vector<Eigen::Vector3d>& x,
...
std::vector<CameraPose> gp3p_wrapper(const std::vector<Eigen::Vector3d>& p,
                                     const std::vector<Eigen::Vector3d>& x,
                                     const std::vector<Eigen::Vector3d>& X) {
  std::vector<CameraPose> output;
  gp3p(p, x, X, &output);
...
std::pair<std::vector<CameraPose>, std::vector<double>> gp4ps_wrapper(
...
std::pair<std::vector<CameraPose>, std::vector<double>> gp4ps_kukelova_wrapper(
    const std::vector<Eigen::Vector3d>& p,
    const std::vector<Eigen::Vector3d>& x,
    const std::vector<Eigen::Vector3d>& X,
    bool filter_solutions = true) {
...
std::pair<std::vector<CameraPose>, std::vector<double>> gp4ps_camposeco_wrapper(
    const std::vector<Eigen::Vector3d>& p,
    const std::vector<Eigen::Vector3d>& x,
    const std::vector<Eigen::Vector3d>& X) {
  std::vector<CameraPose> output;
...
std::pair<std::vector<CameraPose>, std::vector<double>> p4pf_wrapper(
...
std::vector<CameraPose> p2p2pl_wrapper(const std::vector<Eigen::Vector3d>& xp,
...
std::vector<CameraPose> p6lp_wrapper(const std::vector<Eigen::Vector3d>& l,
                                     const std::vector<Eigen::Vector3d>& X) {
  std::vector<CameraPose> output;
  p6lp(l, X, &output);
  return output;
...
std::vector<CameraPose> p5lp_radial_wrapper(
...
std::vector<CameraPose> p2p1ll_wrapper(const std::vector<Eigen::Vector3d>& xp,
                                       const std::vector<Eigen::Vector3d>& Xp,
                                       const std::vector<Eigen::Vector3d>& l,
                                       const std::vector<Eigen::Vector3d>& X,
                                       const std::vector<Eigen::Vector3d>& V) {
...
std::vector<CameraPose> p1p2ll_wrapper(const std::vector<Eigen::Vector3d>& xp,
                                       const std::vector<Eigen::Vector3d>& Xp,
                                       const std::vector<Eigen::Vector3d>& l,
                                       const std::vector<Eigen::Vector3d>& X,
                                       const std::vector<Eigen::Vector3d>& V) {
...
std::vector<CameraPose> p3ll_wrapper(const std::vector<Eigen::Vector3d>& l,
                                     const std::vector<Eigen::Vector3d>& X,
                                     const std::vector<Eigen::Vector3d>& V) {
  std::vector<CameraPose> output;
  p3ll(l, X, V, &output);
...
std::vector<CameraPose> up2p_wrapper(const std::vector<Eigen::Vector3d>& x,
                                     const std::vector<Eigen::Vector3d>& X) {
  std::vector<CameraPose> output;
  up2p(x, X, &output);
  return output;
...
std::vector<CameraPose> ugp2p_wrapper(const std::vector<Eigen::Vector3d>& p,
                                      const std::vector<Eigen::Vector3d>& x,
                                      const std::vector<Eigen::Vector3d>& X) {
  std::vector<CameraPose> output;
  ugp2p(p, x, X, &output);
...
std::pair<std::vector<CameraPose>, std::vector<double>> ugp3ps_wrapper(
    const std::vector<Eigen::Vector3d>& p,
    const std::vector<Eigen::Vector3d>& x,
    const std::vector<Eigen::Vector3d>& X,
    bool filter_solutions = true) {
...
std::vector<CameraPose> up1p2pl_wrapper(const std::vector<Eigen::Vector3d>& xp,
                                        const std::vector<Eigen::Vector3d>& Xp,
                                        const std::vector<Eigen::Vector3d>& x,
                                        const std::vector<Eigen::Vector3d>& X,
                                        const std::vector<Eigen::Vector3d>& V) {
...
std::vector<CameraPose> up4pl_wrapper(const std::vector<Eigen::Vector3d>& x,
                                      const std::vector<Eigen::Vector3d>& X,
                                      const std::vector<Eigen::Vector3d>& V) {
  std::vector<CameraPose> output;
  up4pl(x, X, V, &output);
...
std::vector<CameraPose> ugp4pl_wrapper(const std::vector<Eigen::Vector3d>& p,
                                       const std::vector<Eigen::Vector3d>& x,
                                       const std::vector<Eigen::Vector3d>& X,
                                       const std::vector<Eigen::Vector3d>& V) {
  std::vector<CameraPose> output;
...
std::vector<Eigen::Matrix3d> essential_matrix_relpose_5pt_wrapper(
...
std::vector<CameraPose> relpose_5pt_wrapper(
    const std::vector<Eigen::Vector3d>& x1,
    const std::vector<Eigen::Vector3d>& x2) {
  std::vector<CameraPose> output;
...
ImagePairVector shared_focal_relpose_6pt_wrapper(
    const std::vector<Eigen::Vector3d>& x1,
    const std::vector<Eigen::Vector3d>& x2) {
...
std::vector<CameraPose> relpose_8pt_wrapper(
    const std::vector<Eigen::Vector3d>& x1,
    const std::vector<Eigen::Vector3d>& x2) {
  std::vector<CameraPose> output;
...
Eigen::Matrix3d essential_matrix_8pt_wrapper(
    const std::vector<Eigen::Vector3d>& x1,
    const std::vector<Eigen::Vector3d>& x2) {
...
std::vector<CameraPose> relpose_upright_3pt_wrapper(
    const std::vector<Eigen::Vector3d>& x1,
    const std::vector<Eigen::Vector3d>& x2) {
  std::vector<CameraPose> output;
...
std::vector<CameraPose> gen_relpose_upright_4pt_wrapper(
...
std::vector<CameraPose> gen_relpose_6pt_wrapper(
    const std::vector<Eigen::Vector3d>& p1,
    const std::vector<Eigen::Vector3d>& x1,
    const std::vector<Eigen::Vector3d>& p2,
    const std::vector<Eigen::Vector3d>& x2) {
...
std::vector<CameraPose> relpose_upright_planar_2pt_wrapper(
    const std::vector<Eigen::Vector3d>& x1,
    const std::vector<Eigen::Vector3d>& x2) {
  std::vector<CameraPose> output;
...
std::vector<CameraPose> relpose_upright_planar_3pt_wrapper(
    const std::vector<Eigen::Vector3d>& x1,
    const std::vector<Eigen::Vector3d>& x2) {
  std::vector<CameraPose> output;
...
std::pair<CameraPose, py::dict> estimate_absolute_pose_wrapper(
  ...
  RansacStats stats = estimate_absolute_pose(
      points2D, points3D, camera, ransac_opt, bundle_opt, &pose, &inlier_mask);
...
std::pair<CameraPose, py::dict> estimate_absolute_pose_wrapper(
  ...
  return estimate_absolute_pose_wrapper(
      points2D, points3D, camera, ransac_opt_dict, bundle_opt_dict);
}

std::pair<CameraPose, py::dict> refine_absolute_pose_wrapper(
    const std::vector<Eigen::Vector2d>& points2D,
    const std::vector<Eigen::Vector3d>& points3D,
  ...
  py::gil_scoped_release release;
  BundleStats stats = bundle_adjust(
      points2D_scaled, points3D, norm_camera, &refined_pose, bundle_opt);
  py::gil_scoped_acquire acquire;
...
std::pair<CameraPose, py::dict> refine_absolute_pose_wrapper(
    ...
    const py::dict& bundle_opt_dict) {
  Camera camera = camera_from_dict(camera_dict);
  return refine_absolute_pose_wrapper(
      points2D, points3D, initial_pose, camera, bundle_opt_dict);
}

std::pair<CameraPose, py::dict> estimate_absolute_pose_pnpl_wrapper(
    const std::vector<Eigen::Vector2d>& points2D,
    const std::vector<Eigen::Vector3d>& points3D,
    const std::vector<Eigen::Vector2d>& lines2D_1,
    const std::vector<Eigen::Vector2d>& lines2D_2,
    const std::vector<Eigen::Vector3d>& lines3D_1,
    const std::vector<Eigen::Vector3d>& lines3D_2,
    const Camera& camera,
    const py::dict& ransac_opt_dict,
    const py::dict& bundle_opt_dict) {
  RansacOptions ransac_opt;
  ...
  RansacStats stats = estimate_absolute_pose_pnpl(points2D,
                                                  points3D,
                                                  lines2D,
                                                  lines3D,
                                                  camera,
...
std::pair<CameraPose, py::dict> estimate_absolute_pose_pnpl_wrapper(
    ...
    const py::dict& bundle_opt_dict) {
  Camera camera = camera_from_dict(camera_dict);
  return estimate_absolute_pose_pnpl_wrapper(points2D,
                                             points3D,
                                             lines2D_1,
                                             lines2D_2,
                                             lines3D_1,
...
std::pair<CameraPose, py::dict> refine_absolute_pose_pnpl_wrapper(
  ...
  CameraPose refined_pose = initial_pose;
  BundleStats stats = bundle_adjust(points2D_calib,
                                    points3D,
                                    lines2D_calib,
                                    lines3D,
                                    &refined_pose,
...
std::pair<CameraPose, py::dict> refine_absolute_pose_pnpl_wrapper(
    ...
    const py::dict& line_bundle_opt_dict) {
  Camera camera = camera_from_dict(camera_dict);
  return refine_absolute_pose_pnpl_wrapper(points2D,
                                           points3D,
                                           lines2D_1,
                                           lines2D_2,
                                           lines3D_1,
...
std::pair<CameraPose, py::dict> estimate_generalized_absolute_pose_wrapper(
  ...
  py::gil_scoped_release release;
  RansacStats stats = estimate_generalized_absolute_pose(points2D,
                                                         points3D,
                                                         camera_ext,
                                                         cameras,
                                                         ransac_opt,
...
std::pair<CameraPose, py::dict> estimate_generalized_absolute_pose_wrapper(
  ...
  return estimate_generalized_absolute_pose_wrapper(points2D,
                                                    points3D,
                                                    camera_ext,
                                                    cameras,
                                                    ransac_opt_dict,
...
std::pair<CameraPose, py::dict> refine_generalized_absolute_pose_wrapper(
  ...
  py::gil_scoped_release release;
  BundleStats stats = generalized_bundle_adjust(
      points2D, points3D, camera_ext, cameras, &refined_pose, bundle_opt);
  py::gil_scoped_acquire acquire;
...
std::pair<CameraPose, py::dict> refine_generalized_absolute_pose_wrapper(
  ...
  return refine_generalized_absolute_pose_wrapper(
      points2D, points3D, initial_pose, camera_ext, cameras, bundle_opt_dict);
}

std::pair<CameraPose, py::dict> estimate_relative_pose_wrapper(
  ...
  py::gil_scoped_release release;
  RansacStats stats = estimate_relative_pose(points2D_1,
                                             points2D_2,
                                             camera1,
                                             camera2,
                                             ransac_opt,
...
std::pair<CameraPose, py::dict> estimate_relative_pose_wrapper(
  ...
  return estimate_relative_pose_wrapper(points2D_1,
                                        points2D_2,
                                        camera1,
                                        camera2,
                                        ransac_opt_dict,
...
std::pair<ImagePair, py::dict> estimate_shared_focal_relative_pose_wrapper(
    const std::vector<Eigen::Vector2d>& points2D_1,
    const std::vector<Eigen::Vector2d>& points2D_2,
  ...
  py::gil_scoped_release release;
  RansacStats stats = estimate_shared_focal_relative_pose(points2D_1,
                                                          points2D_2,
                                                          pp,
                                                          ransac_opt,
                                                          bundle_opt,
...
std::pair<CameraPose, py::dict> refine_relative_pose_wrapper(
    const std::vector<Eigen::Vector2d>& points2D_1,
    const std::vector<Eigen::Vector2d>& points2D_2,
    const CameraPose& initial_pose,
    const Camera& camera1,
  ...
  bundle_opt.loss_scale *=
      (1.0 / camera1.focal() + 1.0 / camera2.focal()) * 0.5;

  CameraPose refined_pose = initial_pose;
  BundleStats stats =
      refine_relpose(x1_calib, x2_calib, &refined_pose, bundle_opt);
...
std::pair<CameraPose, py::dict> refine_relative_pose_wrapper(
  ...
  Camera camera1 = camera_from_dict(camera1_dict);
  Camera camera2 = camera_from_dict(camera2_dict);
  return refine_relative_pose_wrapper(
      points2D_1, points2D_2, initial_pose, camera1, camera2, bundle_opt_dict);
}
...
std::pair<Eigen::Matrix3d, py::dict> estimate_fundamental_wrapper(
  ...
  py::gil_scoped_release release;
  RansacStats stats = estimate_fundamental(
      points2D_1, points2D_2, ransac_opt, bundle_opt, &F, &inlier_mask);
  py::gil_scoped_acquire acquire;
...
std::pair<Eigen::Matrix3d, py::dict> refine_fundamental_wrapper(
    const std::vector<Eigen::Vector2d>& points2D_1,
    const std::vector<Eigen::Vector2d>& points2D_2,
  ...
  Eigen::Matrix3d refined_F =
      T2.transpose().inverse() * initial_F * T1.inverse();
  BundleStats stats =
      refine_fundamental(x1_norm, x2_norm, &refined_F, bundle_opt_scaled);
...
std::pair<Eigen::Matrix3d, py::dict> estimate_homography_wrapper(
  ...
  py::gil_scoped_release release;
  RansacStats stats = estimate_homography(
      points2D_1, points2D_2, ransac_opt, bundle_opt, &H, &inlier_mask);
  py::gil_scoped_acquire acquire;
...
std::pair<Eigen::Matrix3d, py::dict> refine_homography_wrapper(
    const std::vector<Eigen::Vector2d>& points2D_1,
    const std::vector<Eigen::Vector2d>& points2D_2,
  ...
  BundleStats stats =
      refine_homography(x1_norm, x2_norm, &refined_H, bundle_opt_scaled);
...
std::pair<CameraPose, py::dict> estimate_generalized_relative_pose_wrapper(
  ...
  py::gil_scoped_release release;
  RansacStats stats = estimate_generalized_relative_pose(matches,
                                                         camera1_ext,
                                                         cameras1,
                                                         camera2_ext,
                                                         cameras2,
...
std::pair<CameraPose, py::dict> estimate_generalized_relative_pose_wrapper(
  ...
  return estimate_generalized_relative_pose_wrapper(matches,
                                                    camera1_ext,
                                                    cameras1,
                                                    camera2_ext,
                                                    cameras2,
...
std::pair<CameraPose, py::dict> refine_generalized_relative_pose_wrapper(
  ...
  CameraPose refined_pose = initial_pose;
  BundleStats stats = refine_generalized_relpose(
      calib_matches, camera1_ext, camera2_ext, &refined_pose, bundle_opt);
...
std::pair<CameraPose, py::dict> refine_generalized_relative_pose_wrapper(
  ...
  return refine_generalized_relative_pose_wrapper(matches,
                                                  initial_pose,
                                                  camera1_ext,
                                                  cameras1,
                                                  camera2_ext,
...
std::pair<CameraPose, py::dict> estimate_hybrid_pose_wrapper(
    ...
    const std::vector<Camera>& map_cameras,
    const py::dict& ransac_opt_dict,
    const py::dict& bundle_opt_dict) {
  RansacOptions ransac_opt;
  update_ransac_options(ransac_opt_dict, ransac_opt);
  ...
  bundle_opt.loss_scale =
      0.25 * (ransac_opt.max_reproj_error + ransac_opt.max_epipolar_error);
  update_bundle_options(bundle_opt_dict, bundle_opt);
  ...
  py::gil_scoped_release release;
  RansacStats stats = estimate_hybrid_pose(points2D,
                                           points3D,
                                           matches_2D_2D,
                                           camera,
                                           map_ext,
...
std::pair<CameraPose, py::dict> estimate_hybrid_pose_wrapper(
    ...
    const py::dict& camera_dict,
    const std::vector<CameraPose>& map_ext,
    const std::vector<py::dict>& map_camera_dicts,
    const py::dict& ransac_opt_dict,
    const py::dict& bundle_opt_dict) {
  Camera camera = camera_from_dict(camera_dict);
  ...
  return estimate_hybrid_pose_wrapper(points2D,
                                      points3D,
                                      matches_2D_2D,
                                      camera,
                                      map_ext,
...
std::pair<CameraPose, py::dict> estimate_1D_radial_absolute_pose_wrapper(
  ...
  py::gil_scoped_release release;
  RansacStats stats = estimate_1D_radial_absolute_pose(
      points2D, points3D, ransac_opt, bundle_opt, &pose, &inlier_mask);
  py::gil_scoped_acquire acquire;
...
std::pair<std::vector<CameraPose>, std::vector<Point3D>>
motion_from_homography_wrapper(Eigen::Matrix3d& H) {
...
std::tuple<Camera, Camera, int> focals_from_fundamental_iterative_wrapper(
  ...
  py::gil_scoped_release release;
  return focals_from_fundamental_iterative(
      F, camera1, camera2, max_iters, weights);
}
...
PYBIND11_MODULE(poselib, m) {
  py::class_<poselib::CameraPose>(m, "CameraPose")
      ...
      .def_property("R",
                    &poselib::CameraPose::R,
                    [](poselib::CameraPose& self, Eigen::Matrix3d R_new) {
                      self.q = poselib::rotmat_to_quat(R_new);
                    })
      .def_property(
          "Rt",
          &poselib::CameraPose::Rt,
          [](poselib::CameraPose& self, Eigen::Matrix<double, 3, 4> Rt_new) {
            self.q = poselib::rotmat_to_quat(Rt_new.leftCols<3>());
            self.t = Rt_new.col(3);
          })
      .def("center",
           &poselib::CameraPose::center,
  ...
  py::class_<poselib::Camera>(m, "Camera")
      ...
      .def("model_name",
           &poselib::Camera::model_name,
           "Returns the camera model name.")
      .def("prinicipal_point",
           &poselib::Camera::principal_point,
           "Returns the camera principal point.")
      .def("initialize_from_txt",
           &poselib::Camera::initialize_from_txt,
      ...
      .def("__repr__",
           [](const poselib::Camera& a) { return a.to_cameras_txt(); });
  ...
  py::class_<poselib::Image>(m, "Image")
      ...
      .def("__repr__", [](const poselib::Image& a) {
        return "[pose q: " + toString(a.pose.q.transpose()) +
               ", t: " + toString(a.pose.t.transpose()) +
  ...
  py::class_<poselib::ImagePair>(m, "ImagePair")
      ...
      .def("__repr__", [](const poselib::ImagePair& a) {
        return "[pose q: " + toString(a.pose.q.transpose()) +
               ", t: " + toString(a.pose.t.transpose()) +
               ", camera1: " + a.camera1.to_cameras_txt() +
  ...
  py::class_<poselib::PairwiseMatches>(m, "PairwiseMatches")
      ...
      .def("__repr__", [](const poselib::PairwiseMatches& a) {
        return "[cam_id1: " + std::to_string(a.cam_id1) + "\n" +
               ...
               std::to_string(a.x1.size()) + "]\n" + "x2: [2x" +
               std::to_string(a.x2.size()) + "]]\n";
      });

  m.doc() =
      "This library provides a collection of minimal solvers for camera "
      "pose estimation.";
  ...
  m.def("gp3p",
        &poselib::gp3p_wrapper,
        py::arg("p"),
        py::arg("x"),
        py::arg("X"),
        py::call_guard<py::gil_scoped_release>());
  m.def("gp4ps",
        &poselib::gp4ps_wrapper,
        py::arg("p"),
        py::arg("x"),
        py::arg("X"),
        py::arg("filter_solutions"),
        py::call_guard<py::gil_scoped_release>());
  m.def("gp4ps_kukelova",
        ...
        py::arg("filter_solutions"),
        py::call_guard<py::gil_scoped_release>());
  m.def("gp4ps_camposeco",
        &poselib::gp4ps_camposeco_wrapper,
        py::arg("p"),
        py::arg("x"),
        py::arg("X"),
        py::call_guard<py::gil_scoped_release>());
  m.def("p4pf",
        &poselib::p4pf_wrapper,
        py::arg("x"),
        py::arg("X"),
        py::arg("filter_solutions"),
        py::call_guard<py::gil_scoped_release>());
  m.def("p2p2pl",
        &poselib::p2p2pl_wrapper,
        py::arg("xp"),
        py::arg("Xp"),
        py::arg("x"),
        py::arg("X"),
        ...
        py::call_guard<py::gil_scoped_release>());
  m.def("p6lp",
        &poselib::p6lp_wrapper,
        py::arg("l"),
        py::arg("X"),
        py::call_guard<py::gil_scoped_release>());
  m.def("p5lp_radial",
        &poselib::p5lp_radial_wrapper,
        py::arg("l"),
        py::arg("X"),
        py::call_guard<py::gil_scoped_release>());
  m.def("p2p1ll",
        &poselib::p2p1ll_wrapper,
        py::arg("xp"),
        py::arg("Xp"),
        py::arg("l"),
        py::arg("X"),
  ...
  m.def("p1p2ll",
        ...
        py::call_guard<py::gil_scoped_release>());
  m.def("p3ll",
        &poselib::p3ll_wrapper,
        py::arg("l"),
        py::arg("X"),
        py::arg("V"),
        py::call_guard<py::gil_scoped_release>());
  m.def("up2p",
        &poselib::up2p_wrapper,
        py::arg("x"),
        py::arg("X"),
        py::call_guard<py::gil_scoped_release>());
  m.def("ugp2p",
        &poselib::ugp2p_wrapper,
        py::arg("p"),
        py::arg("x"),
        py::arg("X"),
        py::call_guard<py::gil_scoped_release>());
  m.def("ugp3ps",
        &poselib::ugp3ps_wrapper,
        py::arg("p"),
        py::arg("x"),
        py::arg("X"),
        py::arg("filter_solutions"),
  ...
  m.def("up1p2pl",
        ...
        py::call_guard<py::gil_scoped_release>());
  m.def("up4pl",
        &poselib::up4pl_wrapper,
        py::arg("x"),
        py::arg("X"),
        py::arg("V"),
        py::call_guard<py::gil_scoped_release>());
  m.def("ugp4pl",
        &poselib::ugp4pl_wrapper,
        py::arg("p"),
        py::arg("x"),
        py::arg("X"),
        py::arg("V"),
        py::call_guard<py::gil_scoped_release>());
  m.def("essential_matrix_5pt",
        &poselib::essential_matrix_relpose_5pt_wrapper,
        py::arg("x1"),
        py::arg("x2"),
        py::call_guard<py::gil_scoped_release>());
  m.def("shared_focal_relpose_6pt",
        &poselib::shared_focal_relpose_6pt_wrapper,
        py::arg("x1"),
        py::arg("x2"),
        py::call_guard<py::gil_scoped_release>());
  m.def("relpose_5pt",
        &poselib::relpose_5pt_wrapper,
        py::arg("x1"),
        py::arg("x2"),
        py::call_guard<py::gil_scoped_release>());
  m.def("relpose_8pt",
        &poselib::relpose_8pt_wrapper,
        py::arg("x1"),
        py::arg("x2"),
        py::call_guard<py::gil_scoped_release>());
  m.def("essential_matrix_8pt",
        &poselib::essential_matrix_8pt_wrapper,
        py::arg("x1"),
        py::arg("x2"),
        py::call_guard<py::gil_scoped_release>());
  m.def("relpose_upright_3pt",
        &poselib::relpose_upright_3pt_wrapper,
        py::arg("x1"),
        py::arg("x2"),
        py::call_guard<py::gil_scoped_release>());
  m.def("gen_relpose_upright_4pt",
        &poselib::gen_relpose_upright_4pt_wrapper,
        py::arg("p1"),
        py::arg("x1"),
        py::arg("p2"),
        py::arg("x2"),
        py::call_guard<py::gil_scoped_release>());
  m.def("gen_relpose_6pt",
        &poselib::gen_relpose_6pt_wrapper,
        py::arg("p1"),
        py::arg("x1"),
        py::arg("p2"),
        py::arg("x2"),
        py::call_guard<py::gil_scoped_release>());
  m.def("relpose_upright_planar_2pt",
        &poselib::relpose_upright_planar_2pt_wrapper,
        py::arg("x1"),
        py::arg("x2"),
        py::call_guard<py::gil_scoped_release>());
  m.def("relpose_upright_planar_3pt",
        &poselib::relpose_upright_planar_3pt_wrapper,
        py::arg("x1"),
        py::arg("x2"),
        py::call_guard<py::gil_scoped_release>());
  ...
  m.def("estimate_absolute_pose_pnpl",
        ...
        "Absolute pose estimation with non-linear refinement from points and "
        "lines.");
  m.def("estimate_absolute_pose_pnpl",
        py::overload_cast<const std::vector<Eigen::Vector2d>&,
                          const std::vector<Eigen::Vector3d>&,
  ...
  m.def("estimate_generalized_absolute_pose",
        py::overload_cast<const std::vector<std::vector<Eigen::Vector2d>>&,
                          ...
                          const std::vector<poselib::CameraPose>&,
                          const std::vector<poselib::Camera>&,
                          const py::dict&,
                          const py::dict&>(
  ...
  m.def("estimate_shared_focal_relative_pose",
        &poselib::estimate_shared_focal_relative_pose_wrapper,
        py::arg("points2D_1"),
        py::arg("points2D_2"),
        py::arg("pp") = Eigen::Vector2d::Zero(),
        py::arg("ransac_opt") = py::dict(),
        py::arg("bundle_opt") = py::dict(),
        "Relative pose estimation with unknown equal focal lengths with "
        "non-linear refinement.");
  m.def("estimate_fundamental",
        &poselib::estimate_fundamental_wrapper,
        py::arg("points2D_1"),
        py::arg("points2D_2"),
        py::arg("ransac_opt") = py::dict(),
        py::arg("bundle_opt") = py::dict(),
        "Fundamental matrix estimation with non-linear refinement. Note: if "
        "you have known intrinsics you should use "
        "estimate_relative_pose instead!");
  m.def("estimate_homography",
        &poselib::estimate_homography_wrapper,
        py::arg("points2D_1"),
        py::arg("points2D_2"),
        py::arg("ransac_opt") = py::dict(),
        py::arg("bundle_opt") = py::dict(),
  ...
  m.def("estimate_generalized_relative_pose",
        py::overload_cast<const std::vector<poselib::PairwiseMatches>&,
                          const std::vector<poselib::CameraPose>&,
                          const std::vector<poselib::Camera>&,
                          const std::vector<poselib::CameraPose>&,
                          const std::vector<poselib::Camera>&,
  ...
  m.def("estimate_hybrid_pose",
        py::overload_cast<const std::vector<Eigen::Vector2d>&,
                          const std::vector<Eigen::Vector3d>&,
                          const std::vector<poselib::PairwiseMatches>&,
                          const poselib::Camera&,
                          const std::vector<poselib::CameraPose>&,
                          const std::vector<poselib::Camera>&,
                          const py::dict&,
                          const py::dict&>(
            &poselib::estimate_hybrid_pose_wrapper),
        "Hybrid camera pose estimation (both 2D-3D and 2D-2D correspondences "
  ...
  m.def("estimate_1D_radial_absolute_pose",
        &poselib::estimate_1D_radial_absolute_pose_wrapper,
        py::arg("points2D"),
        py::arg("points3D"),
        py::arg("ransac_opt") = py::dict(),
        py::arg("bundle_opt") = py::dict(),
        "Absolute pose estimation for the 1D radial camera model with "
        "non-linear refinement.");

  m.def("motion_from_homography",
        &poselib::motion_from_homography_wrapper,
        py::arg("H"));
  m.def("focals_from_fundamental",
        &poselib::focals_from_fundamental,
        py::arg("F"),
        py::arg("pp1"),
        py::arg("pp2"));
  m.def("focals_from_fundamental_iterative",
        &poselib::focals_from_fundamental_iterative,
        py::arg("F"),
        py::arg("camera1"),
        py::arg("camera2"),
        py::arg("max_iters") = 50,
  ...
  m.def("focals_from_fundamental_iterative",
        &poselib::focals_from_fundamental_iterative_wrapper,
        py::arg("F"),
        py::arg("camera1_dict"),
        py::arg("camera2_dict"),
        py::arg("max_iters") = 50,
  ...
  m.def("refine_homography",
        &poselib::refine_homography_wrapper,
        py::arg("points2D_1"),
        py::arg("points2D_2"),
        py::arg("initial_H"),
        py::arg("bundle_options") = py::dict(),
        "Homography non-linear refinement.");

  m.def("refine_fundamental",
        &poselib::refine_fundamental_wrapper,
        py::arg("points2D_1"),
        py::arg("points2D_2"),
        py::arg("initial_F"),
        py::arg("bundle_options") = py::dict(),
  ...
  m.def("RansacOptions",
        &poselib::RansacOptions_wrapper,
        py::arg("opt") = py::dict(),
        "Options for RANSAC.");
  m.def("BundleOptions",
        &poselib::BundleOptions_wrapper,
        py::arg("opt") = py::dict(),
